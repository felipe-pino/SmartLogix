...
import { LuUserPlus } from "react-icons/lu"; // Añadido para mantener la consistencia visual
import "../App.css";
      ...
      <div className="auth-page">
        <main className="auth-card">
          <header className="auth-header">
            <LuUserPlus style={{ fontSize: "50px", color: "var(--color-primary)", marginBottom: "15px" }} />
          ...
          <footer className="auth-footer">
            ...
            >
              ¿Ya tienes acceso? <span>Inicia sesión aquí</span>
            </button>
          </footer>
        </main>
      </div>
